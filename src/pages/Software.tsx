...
const experiencesData = [
    ...
    \n• Increased the number of community events attended after dashboard implementation.`, image: '../media/sfcm_logo.png', imageWidth: '100%',  imageHeight: 150 },
    ...
    • UI estimated to have been used by thousands of visitors. Received positive feedback from hotel staff and clients on ease of use and functionality.`, image: '../media/astics_logo.png', imageWidth: '100%',  imageHeight: 150},
    ...
    \n• Co-authored a research publication that advanced understanding of AIDS and heart disease etiologies and identified potential therapeutic targets for multiple diseases.`, image: '../media/cityu_logo.png', imageWidth: '100%',  imageHeight: 150},
    // add more data objects as needed
  ];

  const projectsData = [
    { image: `../media/chord_progression_image.png`, header: 'Chord Progression Generator', subheader: 'JavaScript, HTML, CSS', link: 'https://github.com/juanlucasumali/chord-progression-generator-3000', description: `• Developed a chord progression generator that allows users to generate and customize chord progressions for music composition. 
    • Created and deployed the website using HTML, CSS, and JavaScript.`, imageWidth: '100%',  imageHeight: 300 },
    { image: `../media/ml_python_implementation.png`, header: 'Python Implementation of ML Models', subheader: 'Python', link: 'https://github.com/juanlucasumali/KNN-from-scratch', description: `• Implemented KNN and decision tree machine learning models from scratch using Python.
    ...
    { image: `../media/public/evolving_car_ais.png`, header: 'Neuroevolution Simulation of Self-Driving Car AIs in Unity 3D', subheader: 'C#, Unity 3D, ML-Agents Toolkit', link: '', description: `• Simulated neuroevolution in Unity 3D using C# and Unity ML-Agents toolkit. 
